...
public class New_Dua extends Activity implements OnClickListener, OnLongClickListener {
	...
	public boolean onLongClick(View arg0) {
		...
		Hotornot entry=new Hotornot(New_Dua.this);
		entry.open();
			...
			if(diditwork)
			{
				...
				d.show();
				 final Timer t = new Timer();
	                ...
	                Toast.makeText(New_Dua.this, "Saved Successfully", 0).show();
